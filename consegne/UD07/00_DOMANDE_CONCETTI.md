# UD07 — Risposte alle domande sui concetti
 ...
 1. **Domanda:** Perché `--query` è preferibile a cercare manualmente una stringa nell'output JSON?
 <br>
...
2. **Domanda:** Qual è la differenza tra `table` e `tsv` in Azure CLI?
<br>
...
3. **Domanda:** Che cosa significa lavorare con oggetti in PowerShell?
<br>
...
4. **Domanda:** Che cosa significa che una procedura amministrativa è idempotente?
<br>
...
5. **Domanda:** Distingui Activity Log, Metrics e Logs.
<br>
...
6. **Domanda:** A che cosa serve un Log Analytics workspace?
<br>
...
7. **Domanda:** A che cosa serve una diagnostic setting?
<br>
...
8. **Domanda:** Perché Activity Log e AzureActivity non sono esattamente la stessa cosa?
<br>
...
9. **Domanda:** Distingui Alert Rule e Action Group
<br> 
...
10. **Domanda:** Perché un alert Fired non equivale automaticamente a un incidente?
<br>
...
11. **Domanda:** Qual è la differenza tra correlazione e causalità?
<br>
...
12. **Domanda:** Quali sono i passaggi essenziali di un troubleshooting ripetibile?
<br>
